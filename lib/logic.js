...
async function setupDemo(setupDemo){
    ...
    for(var i = 0; i<3; i++) {
        ...
        for (var j=0; j<2; j++) {
          ...
          counter++; 
          mission.missionName = 'Mission ' + counter;
          mission.missionDescription = 'This is the description for this mission.';
          mission.bonusEducoin = 2;
          mission.maxStudents = 3;
          mission.mentorFare = 4; 
          mission.currentStudents = 0;
          mission.campaign = campaign; 
          mission.dueDate = new Date(2018, 10, 31, 12, 0, 0, 0);
          ...
          for(k=0; k<2; k++){
              ...
              activity.description = "This is the description for this activity."; 
              activity.educoin = 3; 
    ...
    // create a mentor
    const mentor = factory.newResource(NS, 'Mentor','mentor@email.com');
